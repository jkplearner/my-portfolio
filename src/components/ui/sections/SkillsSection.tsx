...
const SkillsSection: React.FC = () => {
  const skills: Skill[] = [
    ...
    {
      category: "Salesforce",
      items: ["Salesforce CRM", "Lightning Web Components (LWC)", "Agentforce", "Flow Automation"]
    },
    {
      category: "Backend",
      items: ["Node.js", "Express.js", "REST APIs", "System Integration", "Data Synchronization"]
    },
    {
      category: "Frontend",
      items: ["React.js", "Responsive UI Development"]
    },
    {
      category: "Databases",
      items: ["MongoDB", "MySQL"]
    },
    {
      ...
      items: ["Service-layered Design", "Multi-tenant Data Handling", "AI-Scoped Processing"]
    },
    {
      category: "Tools",
      items: ["Git", "GitHub", "Vercel", "Render", "MongoDB Atlas"]
    }
  ];
